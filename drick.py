...
def ping():
	...
	if response == 0:
		...
		print (host, "está offline ou inascessivel\n")
...
def cap_ban():
	...
	try:
		...
		print("\nErro: erro de protocolo / porta ou host inacessivel.")
			...
			while x == True:
				...
				if xx == npa:
					...
					if ay == 2:
						...
						print("\nMaior tempo de transferencia por pacote:", "\033[32m", maior, "\033[0;0m", "\nMaior area de oscilação:", "\033[32m", maior_o, "%", "\033[0;0m", "\nDiferença de area:\n", "\033[32m", "+", dif, "\033[0;0m", "em relação ao", "\033[32m", task, "\033[0;0m","\nTempo medio por pacote:\n", "\033[32m", "+", dt, "\033[0;0m", "em relação ao", "\033[32m", taske, "\033[0;0m", "\nMaior tempo total:\n", "\033[32m", maior_t, "\033[0;0m", "\nDiferença de:", "\033[32m", "+", ert, "\033[0;0m", "em relação ao", "\033[32m", atq, "\033[0;0m")
...
while x == True:
	...
	if y == "sair":
		...
		print("\nO software (Drick Framework) é um pacote com varios algoritimos essenciais para um bom pentesting e uma boa analise de um sistema ou rede, o nosso software busca sempre agrupar as melhoresalternativas para uma boa analise e uma rede de testes. \n\nFoi desenvolvido pela iDrick que tem como dono e fundador Wandrew Tischler que tambem é conhecido como Drick um apelido que sua mãe deu na infancia, agora trabalhamos constantemente não só neste programa mas tambem em outros afim de resolver os problemas de pessoas comuns como eu e voce.")
		
	#requisitar informações de determinadas funções
	
	elif y == "/info ping":
		print("\n\033[32m PING\n\033[0;0m\nPING é um algoritimo usado para testar uma maquina remota afim de determinar se ela está online ou offline e obter dados de sua requisição como tempo de resposta.")
	
	elif y == "/info cap ip":
		print("\n\033[32m CAP IP (CAPTURAR IP)\n\033[0;0m\nCAP IP tem como função obter o endereço remoto de uma determinada maquina na rede, o algoritimo captura o ip (Internet Protocol) atraves de uma requisição.")
	
	elif y == "/info tporta":
		print("\n\033[32m TPORTA (TESTAR PORTA)\n\033[0;0m\nTPORTA é um testador de porta especifica nativo da plataforma, basicamente ele testa se uma determinada porta de um dispositivo na rede esta aberta ou fechada.")
	
	elif y == "/info localizar ip":
		print("\n\033[32m LOCALIZAR IP\n\033[0;0m\nEsta função lhe permite rastrear um dispositivo e obter caracteristicas de sua localização.")
	
	elif y == "/info cbanner":
			print("\n\033[32m CBANNER (CAPTURAR BANNER)\n\033[0;0m\nApartir de requisições ao alvo é possivel obter o serviço e sua versão que está a rodar em uma determinada porta com esta informação é possivel obter um exploit.")
		
	elif y == "/info mfr5":
			print("\n\033[32m MFR5 (Monitor de Flutuação Remota)\n\033[0;0m\nCom este algoritimo é possivel enviar requisições para um determinado dispositivo na rede de computadores e compreender melhor como funciona sua rede e quão eficiente ela pode ser.\nFocado na parte de transmissão de dados o MFR pode detectar variações muito pequenas e importantes em um determinado host, variações essas que podem ser usadas em simulações para prever a integridade de uma rede dado um futuro evento.")
		
	elif y == "/info elink":
		print("\n\033[32m ELINK (Extraidor de Link)\n\033[0;0m\nEsse algoritimo tem como função extrair links de uma determinada pagina na web.")
	
	elif y == "/info pscan":
		print("\n\033[32m PSCAN (Scanner de Portas)\n\033[0;0m\nPSCAN é um scanner de portas simples que tem o intuito de testar as principais portas de um host e determinar de as mesmas estão abertas ou fechadas.")
