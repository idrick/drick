...
def cap_ban():
	...
	try:
		...
		print("\nErro: erro de protocolo / porta ou host inacessível.")
...
while x == True:
	...
	if y == "/sair":
		...
		print('\nO software (Drick Framework) é um pacote com vários algoritimos essênciais para um bom pentesting e uma boa análise de um sistema ou rede, o nosso software busca sempre agrupar as melhores alternativas para uma boa análise e uma rede de testes. Foi desenvolvido pela iDrick que tem como dono e fundador Wandrew Tischler que também é conhecido como Drick um apelido que sua mãe deu na infância, agora trabalhamos constantemente não só neste programa mas também em outros afim de resolver os problemas de pessoas comuns como eu e você.\n\nCaso queira consultar alguma informação a respeito de algum programa da plataforma use o comando (/info) + Programa, por exemplo "/info ping", este comando retornará as principais informações sobre o mesmo.')
