...
def mfr5():
	...
	print("\n[\033[33m1\033[0;0m] Monitoramento livre (definir n° de pacotes)")
	print("[\033[33m2\033[0;0m] Monitoramento 2 etapas (gera comparações)")
	print("[\033[33m3\033[0;0m] Fechar execução")
...
nomep = "\033[36m" + "DRICK FRAMEWORK [1.1]" "\033[0;0m"
